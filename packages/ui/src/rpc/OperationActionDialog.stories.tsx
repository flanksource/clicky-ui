...
const meta: Meta<typeof OperationActionDialog> = {
  title: "Clicky-RPC/OperationActionDialog",
  component: OperationActionDialog,
  parameters: {
    docs: {
      description: {
        component:
          "Modal launcher used by clicky-rpc surfaces to execute an OpenAPI operation. These stories use a stubbed client that fakes a 600ms round-trip and returns a plain-text result.",
      },
    },
  },
};
...
export default meta;
type Story = StoryObj<typeof OperationActionDialog>;

export const ServiceAction: Story = {
  args: {
