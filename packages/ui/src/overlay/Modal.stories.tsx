...
const meta: Meta<typeof Modal> = {
  ...
  argTypes: {
    ...
    closeOnBackdrop: {
      control: "boolean",
      description: "Close when the backdrop is clicked. Off by default.",
    ...
    docs: {
      description: {
        component: [
          ...
          "",
          "**Behavior**",
          "- Closes on Escape (`closeOnEsc`, on by default) and the close button; backdrop click is opt-in via `closeOnBackdrop`.",
