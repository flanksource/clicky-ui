    ...
    <div className="mx-auto max-w-3xl space-y-6">
      <header className="space-y-2">
        ...
        <p className="text-muted-foreground">
          ...
          <code className="rounded bg-muted px-1 py-0.5 text-xs">src/pages/</code>, show it to
          someone, collect their notes, hand the whole thing to an agent.
        </p>
      </header>

      <ol className="space-y-4">
        <Step n={1} title="Create an artifact">
          Add <code className="rounded bg-muted px-1 py-0.5 text-xs">src/pages/my-idea.tsx</code>{" "}
          with a default-exported component. It shows up in the sidebar immediately — no catalog to
          edit. Optionally{" "}
        ...
        <Step n={2} title="Grab an element for your agent">
          Hover anything and press <kbd className="rounded border border-border px-1 text-xs">⌘C</kbd>
          . react-grab copies the element, its React component stack and its source location — paste
          it into Claude Code.
        </Step>
      ...
      <section className="space-y-3 rounded-lg border border-border p-4">
        ...
        <p className="text-sm text-muted-foreground">
          The full <code className="rounded bg-muted px-1 py-0.5 text-xs">@flanksource/clicky-ui</code>{" "}
          library, the theme tokens (try the theme and density switchers above), plain Tailwind, and
          any Iconify icon by name.
        </p>
        <div className="flex flex-wrap items-center gap-3">
          ...
          <span className="inline-flex items-center gap-1.5 rounded-md bg-muted px-2 py-1 text-sm">
            <iconify-icon icon="ph:rocket-launch-duotone" width="18" height="18" />
            any iconify name
          </span>
        </div>
      </section>
