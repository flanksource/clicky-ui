  ...
  return (
    ...
    >
      <DataTable
        ...
        columnResizeStorageKey="clicky-ui-kitchen-data-table-default"
        filterBarProps={{
          timeRange: {
            from: timeFrom,
            to: timeTo,
      ...
      <div className="space-y-density-2 border-t border-border pt-density-3">
        ...
        <DataTable
          ...
          columnResizeStorageKey="clicky-ui-kitchen-data-table-everything-fits"
        />
      </div>

      <div className="space-y-density-2 border-t border-border pt-density-3">
        <h3 className="text-sm font-medium">Lots of columns</h3>
        <DataTable
          data={wideRows}
          columns={wideColumns}
          autoFilter
