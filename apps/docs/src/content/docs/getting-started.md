...
| `@flanksource/clicky-ui/expressions` | Monaco language registration, completion, and hover support |
| `@flanksource/clicky-ui/expressions/playground` | React expression editor and evaluation panels |

Use subpath imports to keep the consumer's entry surface explicit. Expression support lives in the two dedicated entry points above; see the [expression guide](/guides/expressions/) for editor registration and playground API setup.
