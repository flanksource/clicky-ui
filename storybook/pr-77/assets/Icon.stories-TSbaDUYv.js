import{B as a,aa as R,ab as T,j as e,P as w,h as M,x as A,ac as F,ad as H,ae as K}from"./iframe-CiA63uuc.js";import{S as O,I as s}from"./Icon-ChAy_Zq6.js";import"./preload-helper-DqldIB3Q.js";import"./utils-DW-IJACk.js";const P={title:"Data/Icon",component:s,args:{icon:a,className:"text-green-600 text-xl",title:"approved",style:"plain",tone:"neutral"},argTypes:{icon:{table:{disable:!0}},style:{control:"inline-radio",options:["plain","badge"]},tone:{control:"inline-radio",options:["emerald","amber","rose","slate","sky","violet","neutral"]},size:{control:"inline-radio",options:O}},parameters:{docs:{description:{component:'Renders statically imported icon components for built-in icons. Runtime string names are for user-supplied data handled by a registered fallback provider. Use `style="badge"` when the icon needs its own circular chip.'}}}},r={args:{icon:a,className:"text-green-600 text-xl"}},n={args:{icon:R,className:"text-red-600 text-xl"}},o={args:{icon:T,className:"text-blue-500 text-2xl"}},i={args:{icon:a,style:"badge",tone:"emerald",size:"lg",title:"approved"}},c={render:()=>e.jsx("div",{className:"flex items-end gap-4",children:O.map(t=>e.jsxs("div",{className:"flex flex-col items-center gap-2",children:[e.jsx(s,{icon:a,style:"badge",tone:"emerald",size:t,title:"approved"}),e.jsx("span",{className:"font-mono text-[10px] text-muted-foreground",children:t})]},t))})},L=["codicon:check","codicon:error","codicon:warning","codicon:info","codicon:beaker","codicon:rocket","svg-spinners:ring-resize"],l={parameters:{docs:{description:{story:"User-supplied runtime icon names resolved by the registered fallback provider. With no provider registered (as in Storybook) each name renders the documented dashed placeholder."}}},render:()=>e.jsx("div",{className:"flex flex-col gap-density-2",children:L.map(t=>e.jsxs("div",{className:"flex items-center gap-density-2 text-sm",children:[e.jsx(s,{name:t,className:"text-xl",title:t}),e.jsx("code",{className:"text-xs text-muted-foreground",children:t})]},t))})},d={render:()=>e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx(s,{icon:a,style:"badge",tone:"emerald",size:"lg",title:"approved"}),e.jsx(s,{icon:w,style:"badge",tone:"amber",size:"lg",title:"pending"}),e.jsx(s,{icon:M,style:"badge",tone:"rose",size:"lg",title:"rejected"}),e.jsx(s,{icon:A,style:"badge",tone:"sky",size:"lg",title:"info"}),e.jsx(s,{icon:F,style:"badge",tone:"violet",size:"lg",title:"starred"}),e.jsx(s,{icon:H,style:"badge",tone:"slate",size:"lg",title:"draft"}),e.jsx(s,{icon:K,style:"badge",tone:"neutral",size:"lg",title:"unknown"})]})};var m,p,g;r.parameters={...r.parameters,docs:{...(m=r.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    icon: UiCheck,
...
}`,...(B=(_=d.parameters)==null?void 0:_.docs)==null?void 0:B.source}}};const q=["Check","Error","Spinner","Badge","BadgeSizes","RuntimeNames","BadgeTones"];export{i as Badge,c as BadgeSizes,d as BadgeTones,r as Check,n as Error,l as RuntimeNames,o as Spinner,q as __namedExportsOrder,P as default};
