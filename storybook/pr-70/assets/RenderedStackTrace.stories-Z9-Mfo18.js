import{j as n}from"./iframe-1nhP4pBA.js";import{S as w,p as B}from"./RenderedStackTrace-B7-iG5k4.js";import"./preload-helper-C9Uksf5K.js";import"./frame-heuristics-D62qKi0n.js";import"./Icon-B2d9yic_.js";import"./utils-DW-IJACk.js";import"./StackFrameRow-Cb9m8vKM.js";import"./FrameSourceWindow-iVvp6sss.js";import"./HighlightedTokens-BrlLwXpa.js";const ee={title:"Data/Diagnostics/StackTrace",component:w,parameters:{layout:"padded",docs:{description:{component:"Parses and renders a free-form Java stack trace. Pass `resolver` to attach inline source context (±N lines) under each frame. Pass `include`/`exclude` to filter frames by package prefix; `hideRuntimeOnly` mutes JDK/framework frames."}}}},e=`java.lang.NullPointerException: name must not be null
