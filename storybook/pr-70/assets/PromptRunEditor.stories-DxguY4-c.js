import{r as f,j as i,bD as te,u as ie,bR as ne}from"./iframe-CrD5m2_8.js";import{B as T}from"./button-KKR3itPP.js";import{J as re}from"./JsonSchemaForm-Dw6l687S.js";import{c as se}from"./utils-DW-IJACk.js";import{M as oe}from"./Modal-H6VyPbTT.js";import{I as S}from"./Icon-BTfkw-8h.js";import{D as le}from"./effort-icons-DzBSslH2.js";import{c as ce,A as de,a as me}from"./Attachment-C3noLCjL.js";import{R as ue}from"./RuntimeBar-BBVB0cEn.js";import{S as pe,l as fe}from"./runtime-mode-B4pS5QxQ.js";import{w,S as xe}from"./index-Cb4ir5Bc.js";import"./preload-helper-C9Uksf5K.js";import"./index-CPURVhFy.js";import"./loading-Czeqb770.js";import"./DropdownMenu-O6TM5ArU.js";import"./floating-ui.react-CP7HTaTu.js";import"./index-oGxvMW6m.js";import"./index-BJrxtn44.js";import"./DropdownMenuSubmenu-BtYF0q-O.js";import"./modalStack-DuaGAyy0.js";import"./zIndex-BGbNBNA8.js";import"./HoverCard-CaFs7vh3.js";import"./path-tree-hRGj2Ywe.js";import"./json-schema-form-size-E77C3uZS.js";import"./AccordionList-DMUxUUka.js";import"./json-schema-form-refs-Ri7m9AHd.js";import"./timestamp-format-CIXhO4AH.js";import"./Combobox-kceivp8R.js";import"./FilterPill-B9M6udAn.js";import"./DateField-BN7ucegy.js";import"./DatePicker-L1eJNuSm.js";import"./DateTimePicker-CLtlKQIR.js";import"./SegmentedControl-DP3H7NPi.js";import"./TreePickerField-CxIavWm8.js";import"./Tree-MaVHVy7U.js";import"./TreeNode-r2emkaoE.js";import"./InputField-DJsU90Fp.js";import"./use-hotkey-lk4EzYMS.js";import"./Switch-LDuAvuxo.js";import"./SecretKeySelector-O_7Xmo11.js";import"./index-DsV-XxBU.js";import"./icon-menu-picker-BmPQg99W.js";import"./IconButton-s9Ye4kh3.js";import"./ProviderStatusPanel-AXaPdhy-.js";import"./agent-action-icons-CxDgdTjg.js";import"./SandboxCreateWizard-CRAMUBuV.js";import"./FixtureEditor-BMWGSXO4.js";import"./MdxEditorField-DZAS4xjY.js";import"./Callout-CHHd0cMh.js";import"./callout-tones-DN7X2Ehz.js";import"./public-api-BjCjxHuM.js";import"./Badge-6O7NPDyz.js";const F=["model","id","backend","temperature","effort","noCache","fallbacks"];function ye(e){if(!e)return{};const a={};for(const r of F){const n=e[r];n!==void 0&&Object.assign(a,{[r]:n})}return a}function ge(e){var a;return(a=e.runtimes)!=null&&a.length?e.runtimes:[ye(e.spec)]}function P(e,a){const r=a[0]??{},n=Re(e.spec??{},r);if(a.length<=1){const p={...e,spec:n};return delete p.runtimes,p}return{...e,spec:n,runtimes:a}}function Re(e,a){const r={...e};for(const n of F)delete r[n];return{...r,...a}}function N({value:e,onChange:a,models:r=[],families:n=pe,tools:p=[],permissionCatalog:R,secretSelector:b,cliOptions:x,sandboxCatalog:m,sandboxCreate:k,reasoningEfforts:d=le,variablesSchema:c,onVariablesValidityChange:A,promptEditor:J,promptLabel:I="User prompt",promptPlaceholder:G="Override the rendered user prompt",enableAttachments:$=!1,attachmentUpload:j,attachmentLimits:q,children:K,header:H,footer:Y,className:Q,editSpecLabel:W="Edit spec",specModalTitle:X="Runtime spec",specSections:B}){var O,U;const[Z,h]=f.useState(!1),o=e.spec??{},u=ge(e),v=r.find(t=>t.id===o.id||t.id===o.model),ee=f.useMemo(()=>j??ce(),[j]),C=(((O=o.prompt)==null?void 0:O.attachments)??[]).map(t=>({type:"file",url:t.id?`/api/attachments/${t.id}`:t.url??"",mediaType:t.mediaType??"application/octet-stream",...t.id?{attachmentId:t.id}:{},...t.size!=null?{size:t.size}:{},...t.filename?{filename:t.filename}:{},...!t.filename&&t.path?{filename:t.path}:{}}));return i.jsxs("div",{className:se("grid gap-density-4",Q),children:[H,i.jsxs(L,{title:"Runtime",children:[i.jsxs("div",{className:"grid gap-density-2",children:[u.map((t,s)=>i.jsxs("div",{role:"group","aria-label":`Runtime ${s+1}`,className:"flex min-w-0 items-center gap-density-2",children:[i.jsx(ue,{value:t,onChange:y=>a(P(e,u.map((l,ae)=>ae===s?y:l))),models:r,families:n,reasoningEfforts:d,ariaLabel:`Runtime ${s+1} controls`}),u.length>1&&i.jsx(T,{size:"sm",variant:"ghost","aria-label":`Remove runtime ${s+1}`,onClick:()=>a(P(e,u.filter((y,l)=>l!==s))),children:i.jsx(S,{icon:te,className:"size-4"})})]},s)),i.jsxs("div",{className:"flex flex-wrap items-center gap-density-2",children:[i.jsxs(T,{size:"sm",variant:"outline","aria-label":"Add runtime",onClick:()=>{var t;return a(P(e,[...u,(t=u[0])!=null&&t.backend?{backend:u[0].backend}:{}]))},children:[i.jsx(S,{icon:ie,className:"size-4"}),"Add runtime"]}),i.jsxs(T,{size:"sm",variant:"outline",onClick:()=>h(!0),children:[i.jsx(S,{icon:ne,className:"size-4"}),W]})]})]}),K]}),i.jsx(L,{title:"Variables",children:i.jsx(be,{...c?{schema:c}:{},value:e.variables??{},onChange:t=>a({...e,variables:t}),...A?{onValidityChange:A}:{}})}),i.jsxs(L,{title:I,children:[J??i.jsx("textarea",{value:((U=o.prompt)==null?void 0:U.user)??"",onChange:t=>a({...e,spec:w(o,{user:t.target.value})}),spellCheck:!1,placeholder:G,"aria-label":I,className:"min-h-[7rem] w-full resize-y rounded-md border border-border bg-background px-density-2 py-density-1 text-sm outline-none focus:ring-2 focus:ring-ring"}),$&&i.jsxs("div",{className:"space-y-density-2",children:[i.jsx(de,{files:C,onRemove:t=>{var s;return a({...e,spec:w(o,{attachments:(((s=o.prompt)==null?void 0:s.attachments)??[]).filter((y,l)=>l!==t)})})}}),i.jsx(me,{files:C,upload:ee,onAdd:t=>{var s;return a({...e,spec:w(o,{attachments:[...((s=o.prompt)==null?void 0:s.attachments)??[],...t.map(y=>{const l=y;return{id:l.attachmentId,mediaType:l.mediaType,size:l.size,...l.filename?{filename:l.filename}:{}}})]})})},...v!=null&&v.inputMediaTypes?{acceptedMediaTypes:v.inputMediaTypes}:{},...q?{limits:q}:{}})]})]}),Y,i.jsx(oe,{open:Z,onClose:()=>h(!1),title:X,size:"full",closeOnEsc:!0,className:"h-[95vh]",children:i.jsx(xe,{value:o,onChange:t=>a({...e,spec:t}),models:r,families:n,tools:p,...R?{permissionCatalog:R}:{},...b?{secretSelector:b}:{},...x?{cliOptions:x}:{},...m?{sandboxCatalog:m}:{},...k?{sandboxCreate:k}:{},...B?{sections:B}:{},onSave:()=>h(!1),onCancel:()=>h(!1),saveLabel:"Done",footerStatus:fe(o.backend,n)})})]})}function L({title:e,children:a}){return i.jsxs("section",{className:"space-y-density-2",children:[i.jsx("div",{className:"text-xs font-semibold uppercase tracking-wide text-muted-foreground",children:e}),a]})}function be({schema:e,value:a,onChange:r,onValidityChange:n}){const p=f.useId(),[R,b]=f.useState(()=>ke(a)),[x,m]=f.useState(null);if(e)return i.jsx(re,{idPrefix:`prompt-vars-${p}`,schema:e,value:a,onChange:d=>r(d),size:"sm"});const k=d=>{if(b(d),!d.trim()){m(null),n==null||n(!0),r({});return}try{const c=JSON.parse(d);c&&typeof c=="object"&&!Array.isArray(c)?(m(null),n==null||n(!0),r(c)):(m("Expected a JSON object"),n==null||n(!1))}catch(c){m(c instanceof Error?c.message:"Invalid JSON"),n==null||n(!1)}};return i.jsxs("div",{className:"space-y-1",children:[i.jsx("textarea",{value:R,onChange:d=>k(d.target.value),spellCheck:!1,placeholder:"{}","aria-label":"Variables JSON",className:"h-28 w-full resize-y rounded-md border border-border bg-background px-density-2 py-density-1 font-mono text-xs outline-none focus:ring-2 focus:ring-ring"}),x&&i.jsx("div",{className:"text-xs text-destructive",children:x})]})}function ke(e){return!e||Object.keys(e).length===0?"{}":JSON.stringify(e,null,2)}try{N.displayName="PromptRunEditor",N.__docgenInfo={description:"",displayName:"PromptRunEditor",filePath:"/home/runner/work/clicky-ui/clicky-ui/packages/ui/src/data/ai/PromptRunEditor/index.tsx",methods:[],props:{value:{defaultValue:null,declarations:[{fileName:"clicky-ui/packages/ui/src/data/ai/PromptRunEditor/index.tsx",name:"TypeLiteral"}],description:"",name:"value",required:!0,tags:{},type:{name:"AIPromptRunValue"}},onChange:{defaultValue:null,declarations:[{fileName:"clicky-ui/packages/ui/src/data/ai/PromptRunEditor/index.tsx",name:"TypeLiteral"}],description:"",name:"onChange",required:!0,tags:{},type:{name:"(value: AIPromptRunValue) => void"}},models:{defaultValue:{value:"[]"},declarations:[{fileName:"clicky-ui/packages/ui/src/data/ai/PromptRunEditor/index.tsx",name:"TypeLiteral"}],description:"",name:"models",required:!1,tags:{},type:{name:"ChatModel[] | undefined"}},families:{defaultValue:{value:`[
  {
    id: "claude",
    label: "Claude",
