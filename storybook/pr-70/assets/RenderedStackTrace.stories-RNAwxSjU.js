import{j as n}from"./iframe-Cui5-lWu.js";import{S as w,p as B}from"./RenderedStackTrace-mUxbP7wi.js";import"./preload-helper-C9Uksf5K.js";import"./frame-heuristics-D62qKi0n.js";import"./Icon-DK_SiWhj.js";import"./utils-DW-IJACk.js";import"./StackFrameRow-CBqqgZcl.js";import"./FrameSourceWindow-SGDm_o0Y.js";import"./HighlightedTokens-NgVqTPUb.js";const ee={title:"Data/Diagnostics/StackTrace",component:w,parameters:{layout:"padded",docs:{description:{component:"Parses and renders a free-form Java stack trace. Pass `resolver` to attach inline source context (±N lines) under each frame. Pass `include`/`exclude` to filter frames by package prefix; `hideRuntimeOnly` mutes JDK/framework frames."}}}},e=`java.lang.NullPointerException: name must not be null
