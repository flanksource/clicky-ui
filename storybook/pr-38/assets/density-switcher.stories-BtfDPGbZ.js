import{j as e}from"./iframe-BxLPOr6M.js";import{D as N}from"./density-switcher-Erc7Aotg.js";import{B as c}from"./button-CcdgmEp6.js";import"./preload-helper-C4wV90-x.js";import"./icon-menu-picker-B9PYmROg.js";import"./floating-ui.react-DuikDt8B.js";import"./index-DOlc9q0f.js";import"./index-CXpH9Yf8.js";import"./utils-CR52uffu.js";import"./Icon-DGql8Ler.js";import"./modalStack-BJc3ZvRY.js";import"./zIndex-CigQ76av.js";import"./IconButton-Cq3M-hmH.js";import"./UiChevronDown-BxzZdAmx.js";import"./UiCheck-DcO0ZANr.js";import"./UiRows-DC-kDGIE.js";import"./UiListFlat-DE0w-QRe.js";import"./index-0zBpNI7D.js";import"./loading-C28S_Ccf.js";const{expect:m,userEvent:t,within:B}=__STORYBOOK_MODULE_TEST__,q={title:"Theming/DensitySwitcher",component:N,tags:["autodocs"],args:{className:"",triggerClassName:"",menuClassName:""},parameters:{docs:{description:{component:"Icon-button picker that toggles control density between `compact`, `comfortable`, and `spacious`. Writes `data-density` on `<html>` and drives the `--control-height`, `--control-padding-x`, `--spacing-unit` and `--font-size-base` tokens."}}}},o={},s={render:()=>e.jsxs("div",{className:"flex flex-col gap-density-4",children:[e.jsx(N,{}),e.jsxs("div",{className:"flex flex-wrap items-center gap-density-2 rounded-lg border border-border p-density-3",children:[e.jsx(c,{size:"sm",children:"Small"}),e.jsx(c,{size:"default",children:"Default"}),e.jsx(c,{size:"lg",children:"Large"}),e.jsx("span",{className:"text-density-base text-muted-foreground",children:"Body text at density-base font size"})]}),e.jsxs("div",{className:"grid grid-cols-3 gap-density-2 text-xs",children:[e.jsxs("div",{className:"rounded border border-border p-density-2",children:[e.jsx("div",{className:"font-mono text-muted-foreground",children:"--spacing-unit"}),e.jsx("div",{className:"mt-density-1 h-density-4 rounded bg-primary"})]}),e.jsxs("div",{className:"rounded border border-border p-density-2",children:[e.jsx("div",{className:"font-mono text-muted-foreground",children:"--control-height"}),e.jsx("div",{className:"mt-density-1 h-control-h rounded bg-secondary"})]}),e.jsxs("div",{className:"rounded border border-border p-density-2",children:[e.jsx("div",{className:"font-mono text-muted-foreground",children:"--control-padding-x"}),e.jsx("div",{className:"mt-density-1 inline-block rounded bg-accent px-control-px py-density-1",children:"x"})]})]})]})},r={play:async({canvasElement:d,step:a})=>{const n=B(d.ownerDocument.body);await a("open menu and pick compact",async()=>{await t.click(n.getByRole("button",{name:/density/i})),await t.click(n.getByRole("menuitemradio",{name:/compact/i})),await m(document.documentElement.getAttribute("data-density")).toBe("compact")}),await a("open menu and pick spacious",async()=>{await t.click(n.getByRole("button",{name:/density/i})),await t.click(n.getByRole("menuitemradio",{name:/spacious/i})),await m(document.documentElement.getAttribute("data-density")).toBe("spacious")})}},i={play:async({canvasElement:d,step:a})=>{const k=B(d.ownerDocument.body).getByRole("button",{name:/density/i});await a("open with Enter, navigate with arrows, select with Enter",async()=>{k.focus(),await t.keyboard("{Enter}"),await t.keyboard("{ArrowDown}"),await t.keyboard("{Enter}");const j=document.documentElement.getAttribute("data-density");await m(["compact","comfortable","spacious"]).toContain(j)})}};var l,u,p;o.parameters={...o.parameters,docs:{...(l=o.parameters)==null?void 0:l.docs,source:{originalSource:"{}",...(p=(u=o.parameters)==null?void 0:u.docs)==null?void 0:p.source}}};var y,g,b;s.parameters={...s.parameters,docs:{...(y=s.parameters)==null?void 0:y.docs,source:{originalSource:`{
...
}`,...(b=(g=s.parameters)==null?void 0:g.docs)==null?void 0:b.source}}};var v,x,w;r.parameters={...r.parameters,docs:{...(v=r.parameters)==null?void 0:v.docs,source:{originalSource:`{
  play: async ({
    canvasElement,
    step
  }) => {
...
}`,...(E=(f=i.parameters)==null?void 0:f.docs)==null?void 0:E.source}}};const G=["Default","WithPreview","ChangesDataAttribute","KeyboardSelection"];export{r as ChangesDataAttribute,o as Default,i as KeyboardSelection,s as WithPreview,G as __namedExportsOrder,q as default};
