import{C as j}from"./CodeBlock-Dul8E8Ao.js";import"./iframe-gCNtXdWy.js";import"./preload-helper-C_Fsq_bH.js";import"./utils-BLSKlp9E.js";import"./JsonView-HlssJdps.js";import"./code-highlight-aivR7nyS.js";const Y={title:"Data/CodeBlock",component:j,args:{language:"json",source:'{ "status": "ok" }',jsonDefaultOpenDepth:2},parameters:{docs:{description:{component:"Code renderer for Clicky payloads and diagnostics. It prefers trusted highlighted HTML, falls back to async Shiki highlighting, and renders JSON as an expandable tree."}}}},e={args:{language:"typescript",source:`type Service = {
  name: string;
