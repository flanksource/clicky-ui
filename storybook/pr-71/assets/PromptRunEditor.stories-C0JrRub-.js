import{r as f,j as t,bD as te,u as ie,bR as ne}from"./iframe-CmyXO54k.js";import{B as T}from"./button-FnyWyL3m.js";import{J as re}from"./JsonSchemaForm-CF3lVLYB.js";import{c as oe}from"./utils-DW-IJACk.js";import{M as se}from"./Modal-DYutI5j-.js";import{I as S}from"./Icon-Cn5Qjct9.js";import{D as le}from"./effort-icons-DeE0ddnZ.js";import{c as ce,A as de,a as me}from"./Attachment-COZ1OcOf.js";import{r as ue,R as pe}from"./RuntimeBar-BLL_JCeH.js";import{S as fe,l as xe}from"./runtime-mode-Cq6q158m.js";import{w,S as ye}from"./index-BdCsj_LH.js";import"./preload-helper-CrzHa85r.js";import"./index-CPURVhFy.js";import"./loading-DtL9kt7i.js";import"./DropdownMenu-DVDI-rKa.js";import"./floating-ui.react-DYdEGXOX.js";import"./index-93oggNQY.js";import"./index-CZqGiS_m.js";import"./DropdownMenuSubmenu-BL4qtYMJ.js";import"./modalStack-BYsPhtu4.js";import"./zIndex-BGbNBNA8.js";import"./HoverCard-C7V5FEHF.js";import"./path-tree-hRGj2Ywe.js";import"./json-schema-form-size-E77C3uZS.js";import"./AccordionList-Cw8Pv10O.js";import"./json-schema-form-refs-Ri7m9AHd.js";import"./timestamp-format-CIXhO4AH.js";import"./Combobox-BaA3oC34.js";import"./FilterPill-BwfzPWF4.js";import"./DateField-DIXNxkpu.js";import"./DatePicker-GFlNua7f.js";import"./DateTimePicker-CQH9V_hE.js";import"./SegmentedControl-D4w90S4E.js";import"./TreePickerField-NGWLyBI9.js";import"./Tree-DQA2bLnF.js";import"./TreeNode-Db7H-uYm.js";import"./InputField-Dq9OWGRX.js";import"./use-hotkey-BG29T2Il.js";import"./Switch-QaNYK4Ji.js";import"./SecretKeySelector-DFNA9R4Q.js";import"./index-BLrjPNKr.js";import"./icon-menu-picker-CsqqaWJb.js";import"./IconButton-BmkZZsr-.js";import"./ProviderStatusPanel-C6d5EF1C.js";import"./agent-action-icons-Jlpb7rcU.js";import"./SandboxCreateWizard-C0MQJ75h.js";import"./FixtureEditor-FJczh7Aj.js";import"./MdxEditorField-DECPL-7P.js";import"./Callout-ZLEeQDPN.js";import"./callout-tones-DN7X2Ehz.js";import"./public-api-BjCjxHuM.js";import"./Badge-B0-F_vJj.js";const F=["model","id","backend","mode","temperature","effort","noCache","fallbacks"];function ge(e){if(!e)return{};const a={};for(const r of F){const n=e[r];n!==void 0&&Object.assign(a,{[r]:n})}return a}function Re(e){var a;return(a=e.runtimes)!=null&&a.length?e.runtimes:[ge(e.spec)]}function P(e,a){const r=a[0]??{},n=be(e.spec??{},r);if(a.length<=1){const p={...e,spec:n};return delete p.runtimes,p}return{...e,spec:n,runtimes:a}}function be(e,a){const r={...e};for(const n of F)delete r[n];return{...r,...a}}function N({value:e,onChange:a,models:r=[],families:n=fe,tools:p=[],permissionCatalog:R,secretSelector:b,cliOptions:x,sandboxCatalog:m,sandboxCreate:k,reasoningEfforts:d=le,variablesSchema:l,onVariablesValidityChange:A,promptEditor:J,promptLabel:I="User prompt",promptPlaceholder:G="Override the rendered user prompt",enableAttachments:$=!1,attachmentUpload:j,attachmentLimits:q,children:K,header:H,footer:Y,className:Q,editSpecLabel:W="Edit spec",specModalTitle:X="Runtime spec",specSections:B}){var O,U;const[Z,h]=f.useState(!1),c=e.spec??{},u=Re(e),v=ue(r,c),ee=f.useMemo(()=>j??ce(),[j]),C=(((O=c.prompt)==null?void 0:O.attachments)??[]).map(i=>({type:"file",url:i.id?`/api/attachments/${i.id}`:i.url??"",mediaType:i.mediaType??"application/octet-stream",...i.id?{attachmentId:i.id}:{},...i.size!=null?{size:i.size}:{},...i.filename?{filename:i.filename}:{},...!i.filename&&i.path?{filename:i.path}:{}}));return t.jsxs("div",{className:oe("grid gap-density-4",Q),children:[H,t.jsxs(L,{title:"Runtime",children:[t.jsxs("div",{className:"grid gap-density-2",children:[u.map((i,o)=>t.jsxs("div",{role:"group","aria-label":`Runtime ${o+1}`,className:"flex min-w-0 items-center gap-density-2",children:[t.jsx(pe,{value:i,onChange:y=>a(P(e,u.map((s,ae)=>ae===o?y:s))),models:r,families:n,reasoningEfforts:d,ariaLabel:`Runtime ${o+1} controls`}),u.length>1&&t.jsx(T,{size:"sm",variant:"ghost","aria-label":`Remove runtime ${o+1}`,onClick:()=>a(P(e,u.filter((y,s)=>s!==o))),children:t.jsx(S,{icon:te,className:"size-4"})})]},o)),t.jsxs("div",{className:"flex flex-wrap items-center gap-density-2",children:[t.jsxs(T,{size:"sm",variant:"outline","aria-label":"Add runtime",onClick:()=>{var i;return a(P(e,[...u,(i=u[0])!=null&&i.backend?{backend:u[0].backend}:{}]))},children:[t.jsx(S,{icon:ie,className:"size-4"}),"Add runtime"]}),t.jsxs(T,{size:"sm",variant:"outline",onClick:()=>h(!0),children:[t.jsx(S,{icon:ne,className:"size-4"}),W]})]})]}),K]}),t.jsx(L,{title:"Variables",children:t.jsx(ke,{...l?{schema:l}:{},value:e.variables??{},onChange:i=>a({...e,variables:i}),...A?{onValidityChange:A}:{}})}),t.jsxs(L,{title:I,children:[J??t.jsx("textarea",{value:((U=c.prompt)==null?void 0:U.user)??"",onChange:i=>a({...e,spec:w(c,{user:i.target.value})}),spellCheck:!1,placeholder:G,"aria-label":I,className:"min-h-[7rem] w-full resize-y rounded-md border border-border bg-background px-density-2 py-density-1 text-sm outline-none focus:ring-2 focus:ring-ring"}),$&&t.jsxs("div",{className:"space-y-density-2",children:[t.jsx(de,{files:C,onRemove:i=>{var o;return a({...e,spec:w(c,{attachments:(((o=c.prompt)==null?void 0:o.attachments)??[]).filter((y,s)=>s!==i)})})}}),t.jsx(me,{files:C,upload:ee,onAdd:i=>{var o;return a({...e,spec:w(c,{attachments:[...((o=c.prompt)==null?void 0:o.attachments)??[],...i.map(y=>{const s=y;return{id:s.attachmentId,mediaType:s.mediaType,size:s.size,...s.filename?{filename:s.filename}:{}}})]})})},...v!=null&&v.inputMediaTypes?{acceptedMediaTypes:v.inputMediaTypes}:{},...q?{limits:q}:{}})]})]}),Y,t.jsx(se,{open:Z,onClose:()=>h(!1),title:X,size:"full",closeOnEsc:!0,className:"h-[95vh]",children:t.jsx(ye,{value:c,onChange:i=>a({...e,spec:i}),models:r,families:n,tools:p,...R?{permissionCatalog:R}:{},...b?{secretSelector:b}:{},...x?{cliOptions:x}:{},...m?{sandboxCatalog:m}:{},...k?{sandboxCreate:k}:{},...B?{sections:B}:{},onSave:()=>h(!1),onCancel:()=>h(!1),saveLabel:"Done",footerStatus:xe(c.backend,n)})})]})}function L({title:e,children:a}){return t.jsxs("section",{className:"space-y-density-2",children:[t.jsx("div",{className:"text-xs font-semibold uppercase tracking-wide text-muted-foreground",children:e}),a]})}function ke({schema:e,value:a,onChange:r,onValidityChange:n}){const p=f.useId(),[R,b]=f.useState(()=>he(a)),[x,m]=f.useState(null);if(e)return t.jsx(re,{idPrefix:`prompt-vars-${p}`,schema:e,value:a,onChange:d=>r(d),size:"sm"});const k=d=>{if(b(d),!d.trim()){m(null),n==null||n(!0),r({});return}try{const l=JSON.parse(d);l&&typeof l=="object"&&!Array.isArray(l)?(m(null),n==null||n(!0),r(l)):(m("Expected a JSON object"),n==null||n(!1))}catch(l){m(l instanceof Error?l.message:"Invalid JSON"),n==null||n(!1)}};return t.jsxs("div",{className:"space-y-1",children:[t.jsx("textarea",{value:R,onChange:d=>k(d.target.value),spellCheck:!1,placeholder:"{}","aria-label":"Variables JSON",className:"h-28 w-full resize-y rounded-md border border-border bg-background px-density-2 py-density-1 font-mono text-xs outline-none focus:ring-2 focus:ring-ring"}),x&&t.jsx("div",{className:"text-xs text-destructive",children:x})]})}function he(e){return!e||Object.keys(e).length===0?"{}":JSON.stringify(e,null,2)}try{N.displayName="PromptRunEditor",N.__docgenInfo={description:"",displayName:"PromptRunEditor",filePath:"/home/runner/work/clicky-ui/clicky-ui/packages/ui/src/data/ai/PromptRunEditor/index.tsx",methods:[],props:{value:{defaultValue:null,declarations:[{fileName:"clicky-ui/packages/ui/src/data/ai/PromptRunEditor/index.tsx",name:"TypeLiteral"}],description:"",name:"value",required:!0,tags:{},type:{name:"AIPromptRunValue"}},onChange:{defaultValue:null,declarations:[{fileName:"clicky-ui/packages/ui/src/data/ai/PromptRunEditor/index.tsx",name:"TypeLiteral"}],description:"",name:"onChange",required:!0,tags:{},type:{name:"(value: AIPromptRunValue) => void"}},models:{defaultValue:{value:"[]"},declarations:[{fileName:"clicky-ui/packages/ui/src/data/ai/PromptRunEditor/index.tsx",name:"TypeLiteral"}],description:"",name:"models",required:!1,tags:{},type:{name:"ChatModel[] | undefined"}},families:{defaultValue:{value:`[
  {
    id: "claude",
    label: "Claude",
...
}`,...(z=(V=E.parameters)==null?void 0:V.docs)==null?void 0:z.source}}};const Ea=["CanonicalRequest"];export{E as CanonicalRequest,Ea as __namedExportsOrder,va as default};
