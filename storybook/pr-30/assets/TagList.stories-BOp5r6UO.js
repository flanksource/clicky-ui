import{j as a}from"./iframe-D5a9zzxb.js";import{T as n,n as T}from"./TagList-CVRqW6N3.js";import"./preload-helper-D5l2DbWZ.js";import"./Badge-BmIv6kEm.js";import"./utils-BLSKlp9E.js";import"./index-1evVQkiP.js";import"./Icon-BWpUElqS.js";import"./HoverCard-B6V_ziiO.js";import"./index-CuNFHwG9.js";import"./index-BSK9IxpD.js";import"./Properties-DDz8M0aY.js";import"./UiZoomOut-B96RrT0K.js";import"./UiCopy-Cc1SFRqt.js";const b=T(["env=production","team=payments","region=us-east-1","tier=critical","owner=ada"]),R={title:"Data/Cells/TagList",component:n,tags:["autodocs"],parameters:{docs:{description:{component:"Renders normalized `key=value` tags as compact badges for table cells. By default it shows `maxVisible` inline and collapses the rest into a `+N` hover popover; `wrap` lays them out across lines instead. Hovering a badge reveals include/exclude/copy actions (wired via `TagActionsProvider`). Build the input with `normalizeTags`."}}},argTypes:{maxVisible:{control:{type:"number",min:1,max:6}},actions:{control:"inline-radio",options:["hover","inline"]},compact:{control:"boolean"},wrap:{control:"boolean"},tags:{control:!1}},args:{tags:b,maxVisible:3,actions:"hover",wrap:!1}},e={render:r=>a.jsx("div",{className:"w-80",children:a.jsx(n,{...r})})},s={args:{wrap:!0},render:r=>a.jsx("div",{className:"w-80",children:a.jsx(n,{...r})})},o={args:{compact:!0},render:r=>a.jsx("div",{className:"w-80",children:a.jsx(n,{...r})})},t={args:{tags:[]}};var i,c,m;e.parameters={...e.parameters,docs:{...(i=e.parameters)==null?void 0:i.docs,source:{originalSource:`{
...
}`,...(h=(x=t.parameters)==null?void 0:x.docs)==null?void 0:h.source}}};const W=["Default","Wrapped","Compact","Empty"];export{o as Compact,e as Default,t as Empty,s as Wrapped,W as __namedExportsOrder,R as default};
