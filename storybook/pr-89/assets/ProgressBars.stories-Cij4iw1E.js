...
}`,...(g=(u=a.parameters)==null?void 0:u.docs)==null?void 0:g.source},description:{story:"2.3 cores used of a 4-core limit.",...(h=(b=a.parameters)==null?void 0:b.docs)==null?void 0:h.description}}};var v,x,C;l.parameters={...l.parameters,docs:{...(v=l.parameters)==null?void 0:v.docs,source:{originalSource:`{
  args: {
    ...FourCores.args,
...
}`,...(f=(O=s.parameters)==null?void 0:O.docs)==null?void 0:f.source},description:{story:"Near-capacity: 7.6 of 8 cores → danger tone.",...(P=(B=s.parameters)==null?void 0:B.docs)==null?void 0:P.description}}};var G,_,R,j,U;t.parameters={...t.parameters,docs:{...(G=t.parameters)==null?void 0:G.docs,source:{originalSource:`{
  args: {
    ...FourCores.args,
    stats: {
      min: 1000,
...
}`,...(R=(_=t.parameters)==null?void 0:_.docs)==null?void 0:R.source},description:{story:"Summary stats drive the hover card's Min/Max/Avg rows.",...(U=(j=t.parameters)==null?void 0:j.docs)==null?void 0:U.description}}};var V,z,S;d.parameters={...d.parameters,docs:{...(V=d.parameters)==null?void 0:V.docs,source:{originalSource:`{
...
}`,...(M=(L=i.parameters)==null?void 0:L.docs)==null?void 0:M.source},description:{story:"Memory as one bar per GB via the `unit` prop: 2.5 GB used of 4 GB.",...(T=(H=i.parameters)==null?void 0:H.docs)==null?void 0:T.description}}};const rr=["FourCores","Horizontal","ValueHidden","NearCapacity","WithStatsHover","CellVariants","MemoryGigabytes"];export{d as CellVariants,a as FourCores,l as Horizontal,i as MemoryGigabytes,s as NearCapacity,c as ValueHidden,t as WithStatsHover,rr as __namedExportsOrder,$ as default};
