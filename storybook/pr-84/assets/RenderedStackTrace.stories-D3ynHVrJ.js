import{j as n}from"./iframe-DFIXOaVS.js";import{S as w,p as B}from"./RenderedStackTrace-CpxcdIu3.js";import"./preload-helper-BDLXYeas.js";import"./frame-heuristics-D62qKi0n.js";import"./Icon-hb4cd-6v.js";import"./utils-DW-IJACk.js";import"./StackFrameRow-DxUb_RpN.js";import"./FrameSourceWindow-BPEqVwxD.js";import"./HighlightedTokens-B3f0PYmL.js";const ee={title:"Data/Diagnostics/StackTrace",component:w,parameters:{layout:"padded",docs:{description:{component:"Parses and renders a free-form Java stack trace. Pass `resolver` to attach inline source context (±N lines) under each frame. Pass `include`/`exclude` to filter frames by package prefix; `hideRuntimeOnly` mutes JDK/framework frames."}}}},e=`java.lang.NullPointerException: name must not be null
