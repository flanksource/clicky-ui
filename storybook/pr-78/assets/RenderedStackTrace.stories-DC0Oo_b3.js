import{j as n}from"./iframe-Cco5TqZn.js";import{S as w,p as B}from"./RenderedStackTrace---7-vBhX.js";import"./preload-helper-CW1BdeJu.js";import"./frame-heuristics-D62qKi0n.js";import"./Icon-C6Dn9DLx.js";import"./utils-DW-IJACk.js";import"./StackFrameRow-Bh3qnMVs.js";import"./FrameSourceWindow-C7WAdttz.js";import"./HighlightedTokens-DbGRJ7uL.js";const ee={title:"Data/Diagnostics/StackTrace",component:w,parameters:{layout:"padded",docs:{description:{component:"Parses and renders a free-form Java stack trace. Pass `resolver` to attach inline source context (±N lines) under each frame. Pass `include`/`exclude` to filter frames by package prefix; `hideRuntimeOnly` mutes JDK/framework frames."}}}},e=`java.lang.NullPointerException: name must not be null
