...
}`,...(u=(m=s.parameters)==null?void 0:m.docs)==null?void 0:u.source}}};var h,f,b;r.parameters={...r.parameters,docs:{...(h=r.parameters)==null?void 0:h.docs,source:{originalSource:`{
  render: () => {
...
}`,...(b=(f=r.parameters)==null?void 0:f.docs)==null?void 0:b.source}}};var y,x,g;a.parameters={...a.parameters,docs:{...(y=a.parameters)==null?void 0:y.docs,source:{originalSource:`{
  render: () => {
    const [open, setOpen] = useState(false);
    return <>
        <button className="px-3 py-1.5 rounded-md bg-primary text-primary-foreground" onClick={() => setOpen(true)}>
...
}`,...(g=(x=a.parameters)==null?void 0:x.docs)==null?void 0:g.source}}};var C,v,w;l.parameters={...l.parameters,docs:{...(C=l.parameters)==null?void 0:C.docs,source:{originalSource:`{
  parameters: {
    viewport: {
    ...
    docs: {
      description: {
        story: "On mobile the modal becomes a borderless, shadowless page with back navigation. Its header and footer stay visible while this long form scrolls inside the body."
      }
    }
  },
...
}`,...(w=(v=l.parameters)==null?void 0:v.docs)==null?void 0:w.source}}};var N,O,j;d.parameters={...d.parameters,docs:{...(N=d.parameters)==null?void 0:N.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(j=(O=d.parameters)==null?void 0:O.docs)==null?void 0:j.source}}};var k,S,E;i.parameters={...i.parameters,docs:{...(k=i.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: () => {
    const [open, setOpen] = useState(false);
    return <>
        <button className="px-3 py-1.5 rounded-md bg-primary text-primary-foreground" onClick={() => setOpen(true)}>
...
}`,...(E=(S=i.parameters)==null?void 0:S.docs)==null?void 0:E.source}}};const _=["Playground","Default","WithFooter","MobileScrollable","ConfirmClose","Expandable"];export{d as ConfirmClose,r as Default,i as Expandable,l as MobileScrollable,s as Playground,a as WithFooter,_ as __namedExportsOrder,U as default};
