import{j as o,r as G}from"./iframe-DXjk5r-a.js";import{R as v}from"./RuntimeBar-B9t3D1iL.js";import"./preload-helper-CcRYDqr-.js";import"./effort-icons-Dl-9HfSv.js";import"./runtime-mode-GAY9Z09E.js";import"./button-BoSQcAdS.js";import"./utils-DW-IJACk.js";import"./index-CPURVhFy.js";import"./loading-BGtnCp6V.js";import"./SegmentedControl-Ch-FYi_O.js";import"./Icon-DC7PbjMy.js";import"./DropdownMenu-BFy8-TKA.js";import"./floating-ui.react-DFDYvl7a.js";import"./index-BXQtcMly.js";import"./index-DcGoyOOZ.js";import"./DropdownMenuSubmenu-Bghn0JQN.js";import"./modalStack-tAQFSeFw.js";import"./zIndex-BGbNBNA8.js";import"./InputField-DXDU6sNM.js";import"./use-hotkey-CwjSq31y.js";const{expect:n,userEvent:c,within:a}=__STORYBOOK_MODULE_TEST__,_=[{id:"anthropic/claude-sonnet-4-6",provider:"anthropic",label:"Claude Sonnet 4.6",reasoning:!0,configured:!0,contextWindow:2e5},{id:"anthropic/claude-opus-4-1",provider:"anthropic",label:"Claude Opus 4.1",reasoning:!0,configured:!0,contextWindow:2e5},{id:"openai/gpt-5-codex",provider:"openai",label:"GPT-5 Codex",reasoning:!0,configured:!0,contextWindow:4e5},{id:"openai/gpt-5-mini",provider:"openai",label:"GPT-5 mini",reasoning:!0,configured:!1,contextWindow:4e5}];function d({initial:e,variant:t="segmented",families:i}){const[s,r]=G.useState(e);return o.jsxs("div",{className:"grid max-w-3xl gap-4 p-6",children:[o.jsx(v,{value:s,onChange:r,models:_,families:i,variant:t}),o.jsx("pre",{className:"rounded-md border border-border bg-muted/30 p-3 font-mono text-xs text-muted-foreground",children:JSON.stringify(s,null,2)})]})}const me={title:"AI/RuntimeBar",component:v,tags:["autodocs"],argTypes:{variant:{control:"inline-radio",options:["segmented","combo"]}},args:{variant:"segmented"},parameters:{layout:"fullscreen",docs:{description:{component:"The runtime as one self-describing control. The default segmented variant gives family, mode, model and reasoning effort their own menu triggers. The combo variant condenses the same values into one summary trigger and exposes direct controls in a single dropdown. Switching family keeps the current mode when the new family has it and drops a model the new provider cannot run. Unsupported modes and efforts stay visible but disabled, and the model can always be entered directly when the catalog does not describe it."}}},render:({variant:e})=>o.jsx(d,{initial:{mode:"agent"},variant:e})},u={},p={render:({variant:e})=>o.jsx(d,{variant:e,initial:{mode:"cli",model:"openai/gpt-5-codex",effort:"high"}})};function K(){const[e,t]=G.useState({mode:"cli",model:"anthropic/claude-sonnet-4-6",effort:"medium",budget:{timeout:"30m",cost:2}});return o.jsx("div",{className:"w-80 max-w-full p-4",children:o.jsx(v,{value:e,onChange:t,models:_,showTimeout:!0,showCost:!0,ariaLabel:"Narrow runtime"})})}const g={args:{variant:"segmented"},render:()=>o.jsx(K,{}),play:async({canvasElement:e})=>{const t=a(e).getByRole("group",{name:"Narrow runtime"}),i=t.querySelector("[data-runtime-bar-section=identity]"),s=t.querySelector("[data-runtime-bar-section=settings]");await n(s.getBoundingClientRect().top).toBeGreaterThan(i.getBoundingClientRect().top),await n(t.scrollWidth).toBe(t.clientWidth),await n(s.scrollWidth).toBe(s.clientWidth);for(const r of["Medium","30m","$2.00"]){const l=a(s).getByText(r);await n(l.scrollWidth).toBeLessThanOrEqual(l.clientWidth)}}},y={args:{variant:"combo"},render:({variant:e})=>o.jsx(d,{variant:e,initial:{mode:"cli",model:"openai/gpt-5-codex",effort:"high"}}),play:async({canvasElement:e})=>{const t=a(e),i=a(document.body),s=t.getByRole("button",{name:"Runtime: Codex, CLI, GPT-5 Codex, effort High"});await c.click(s);const r=await i.findByRole("menu");await n(a(r).getByRole("radiogroup",{name:"Family"})).toBeInTheDocument(),await n(a(r).getByRole("radiogroup",{name:"Runtime mode"})).toBeInTheDocument(),await n(a(r).getByRole("slider",{name:"Reasoning effort"})).toHaveAttribute("aria-valuetext","High"),await n(a(r).queryByLabelText("Model id")).not.toBeInTheDocument();const l=a(r).getByRole("button",{name:"GPT-5 Codex"});await n(l).toHaveAttribute("title","openai/gpt-5-codex"),await n(l).not.toHaveTextContent("openai/gpt-5-codex"),await c.click(a(r).getByRole("radio",{name:"Claude"})),await n(t.getByRole("button",{name:"Runtime: Claude, CLI, Unspecified, effort High"})).toBeInTheDocument(),await n(i.getByRole("menu")).toBeInTheDocument(),await n(a(r).getByRole("radio",{name:"API"})).toBeInTheDocument(),await c.keyboard("{Escape}"),await n(i.queryByRole("menu")).not.toBeInTheDocument()}},m={args:{variant:"segmented"},render:({variant:e})=>o.jsx(d,{initial:{mode:"api"},variant:e}),play:async({canvasElement:e})=>{const t=a(e);await c.click(t.getByTitle("Model — unspecified")),await c.type(await a(document.body).findByLabelText("Model id"),"gemini-3-pro"),await n(t.getByTitle("Model — gemini-3-pro")).toBeInTheDocument()}},h={args:{variant:"segmented"},render:({variant:e})=>o.jsx(d,{variant:e,initial:{mode:"cli",model:"anthropic/claude-opus-4-1"}}),play:async({canvasElement:e})=>{const t=a(e),i=a(document.body);await c.click(t.getByTitle("Family — Claude")),await c.click(await i.findByRole("menuitem",{name:/^Codex/})),await n(t.getByTitle("Codex CLI")).toHaveTextContent("CLI"),await n(t.getByTitle("Model — unspecified")).toBeInTheDocument()}},w={args:{variant:"segmented"},render:({variant:e})=>o.jsx(d,{initial:{mode:"agent"},variant:e,families:[{id:"claude",label:"Claude",provider:"anthropic",modes:[{id:"agent",label:"Agent",mode:"agent",title:"Claude Agent SDK"},{id:"cli",label:"CLI",mode:"cli",title:"Claude Code CLI"}]}]}),play:async({canvasElement:e})=>{const t=a(e),i=a(document.body);await c.click(t.getByTitle("Claude Agent SDK")),await n(i.queryByRole("menuitem",{name:/^API/})).not.toBeInTheDocument()}};var B,b,x;u.parameters={...u.parameters,docs:{...(B=u.parameters)==null?void 0:B.docs,source:{originalSource:"{}",...(x=(b=u.parameters)==null?void 0:b.docs)==null?void 0:x.source}}};var f,C,T;p.parameters={...p.parameters,docs:{...(f=p.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: ({
    variant
...
}`,...(A=(D=y.parameters)==null?void 0:D.docs)==null?void 0:A.source}}};var M,L,k,W,j;m.parameters={...m.parameters,docs:{...(M=m.parameters)==null?void 0:M.docs,source:{originalSource:`{
 ...
 its menu offers the free-text entry alone.`,...(j=(W=m.parameters)==null?void 0:W.docs)==null?void 0:j.description}}};var H,P,N;h.parameters={...h.parameters,docs:{...(H=h.parameters)==null?void 0:H.docs,source:{originalSource:`{
...
}`,...(N=(P=h.parameters)==null?void 0:P.docs)==null?void 0:N.source}}};var q,O,F;w.parameters={...w.parameters,docs:{...(q=w.parameters)==null?void 0:q.docs,source:{originalSource:`{
  args: {
    variant: "segmented"
  },
  render: ({
